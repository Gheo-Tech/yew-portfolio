...
fn skills_vector() -> Vec<Rc<Skill>> {
    ...
    skills_vec! {
        ...
        { "Programming, Web, FrontEnd", "Rust: Leptos", 5, "the best framework ever made" },
        ...
        { "Programming, Blockchain", "Rust: ethers/web3", 4, "sadly kinda buggy in comparison to JS" },
        ...
        { "Smart Contracts, Blockchain", "Solidity, EVM", 4, "not my cup of tea but had to study it" },
